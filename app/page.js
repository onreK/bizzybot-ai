  ...
  return (
    <div className="min-h-screen bg-[#070B14] text-white overflow-x-hidden">
      <SignedOut>
        ...
        {/* BizzyBot answering for BizzyBot. A prospect who asks this widget a
            question is both seeing the product work and becoming a lead in the
            dashboard — and anything it can't answer lands in the
            unanswered-questions queue, which is unusually direct feedback on
            our own marketing.
            Inside <SignedOut> on purpose: signed-in users are redirected to
