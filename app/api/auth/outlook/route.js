...
// openid is required by Microsoft v2.0 whenever profile/email are requested.
const SCOPES = 'openid profile email offline_access User.Read Mail.Read Mail.ReadWrite Mail.Send Calendars.ReadWrite';
