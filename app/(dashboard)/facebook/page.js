...
import {
  Facebook, CheckCircle, AlertCircle, MessageCircle, MessageSquare,
...
export default function FacebookDashboard() {
  ...
  const statCards = [
    { label: 'Messages Replied', value: stats.messagesReplied,   subtext: 'Last 30 days',   icon: MessageCircle,  color: 'blue'   },
    { label: 'Comment Replies',  value: stats.commentReplies,    subtext: 'Last 30 days',   icon: MessageSquare,  color: 'violet' },
    { label: 'Leads Captured',   value: stats.leadsFromFacebook, subtext: 'From Facebook',  icon: UserCheck,      color: 'indigo' },
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">AI-powered Messenger and post comment automation</p>
      </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      {connection.pageName ? connection.pageName : `Page ${connection.pageId}`}
                      {' · '}Responding to Messenger and comments automatically
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-yellow-500/5 rounded-xl border border-yellow-500/20 p-6">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-white">Facebook not connected</p>
                    <p className="text-sm text-gray-400 mt-0.5">Connect your Page to start the AI</p>
                  </div>
                </div>
                <button
                  onClick={() => setActiveTab('connection')}
                  className="px-4 py-2 bg-[#1877F2] hover:bg-[#166FE5] text-white font-medium rounded-lg text-sm transition-colors flex-shrink-0"
                >
            ...
            <div className="p-5 border-b border-gray-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Messenger messages and post comments your AI handled</p>
                </div>
              </div>
              <button
              ...
              {stats.recentMessages?.length > 0 ? (
                  ...
                  {stats.recentMessages.map((msg, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-start gap-3 p-4 bg-[#0D1117] rounded-lg border border-gray-800">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${isDM ? 'bg-blue-500/10' : 'bg-violet-500/10'}`}>
                          {isDM
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-white text-sm font-medium">
                              {msg.sender_name || 'Facebook user'}
                            </span>
                            <span className={`text-xs px-1.5 py-0.5 rounded font-medium ${isDM ? 'bg-blue-500/10 text-blue-400' : 'bg-violet-500/10 text-violet-400'}`}>
                              {isDM ? 'Messenger' : 'Comment'}
                            </span>
                          </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-400 max-w-sm mx-auto leading-relaxed">
                    {connection?.configured
                      ? 'Messenger messages and comment replies will appear here once your first conversation comes in.'
                      : 'Connect your Facebook Page to start tracking AI conversations.'
                    }
                  </p>
                  {!connection?.configured && (
                    <button
                      onClick={() => setActiveTab('connection')}
                      className="mt-5 px-5 py-2.5 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-lg text-sm font-medium transition-colors"
                    >
                      Connect Facebook Page
                    </button>
                  )}
      ...
      {activeTab === 'connection' && (
        <div className="max-w-xl space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">Connect Facebook Messenger</h2>
              <p className="text-sm text-gray-500">Your AI responds to messages on your Page automatically</p>
            </div>
          </div>
              ...
              <div className="space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {connection.pageName && <p className="text-sm text-gray-400">{connection.pageName}</p>}
              ...
              <div className="space-y-5">
                <div className="space-y-2 text-sm text-gray-400">
                  <div className="flex items-start gap-2">
                    ...
                    Click "Connect Facebook Page" below
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-bold mt-0.5">2.</span>
                    Log in to Facebook and select your Business Page
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-bold mt-0.5">3.</span>
                    Approve the permissions — your AI starts responding immediately
                  </div>
                </div>
                ...
                <p className="text-xs text-gray-600 text-center">
                  You'll be asked to select which Facebook Page to connect. Make sure you own or admin that Page.
                </p>
              </div>
            )}
          </div>
          ...
          <p className="text-xs text-gray-600 text-center">
            ...
            {' · '}
            <a
              href="https://www.facebook.com/business/help/messages"
              target="_blank"
              rel="noreferrer"
