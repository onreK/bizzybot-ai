...
export default function CompleteEmailSystem() {
  ...
  // An email's triage record: check the map FIRST (so a just-saved correction
  // wins), then fall back to the inline record Outlook inbox rows carry.
          ...
          {selectedOutlookEmail ? (
            <div className="bg-[#161B22] rounded-xl border border-gray-800 h-[calc(100vh-480px)] min-h-[600px] flex flex-col">
              ...
              <div className="flex-1 p-6 space-y-6 overflow-y-auto">
                ...
                <TriageFlagCard email={selectedOutlookEmail} />
            ...
            <div className="bg-[#161B22] rounded-xl border border-gray-800 h-[calc(100vh-480px)] min-h-[600px] flex flex-col">
              ...
              <div className="flex-1 p-6 space-y-6 overflow-y-auto">
                ...
                <TriageFlagCard email={selectedGmailEmail} />
