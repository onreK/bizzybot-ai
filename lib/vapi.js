...
export function buildVoiceSystemPrompt(s) {
  ...
  parts.push(
    ...
    'When you say a website, domain, or email address aloud, speak it slowly and clearly and pronounce each part distinctly — ' +
    'say the letters of a brand or domain separately (e.g. "example dot com" or "b-i-z dot com") rather than blending them into a ' +
    'single made-up word the caller would not recognize. If you need to transfer or escalate, say so clearly.'
  );
